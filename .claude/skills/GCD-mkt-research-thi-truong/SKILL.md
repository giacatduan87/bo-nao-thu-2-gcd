---
name: GCD-mkt-research-thi-truong
description: >
  ...
  BẮT BUỘC dùng WebSearch để tìm kiếm thực tế — không được đoán mò.
...
## QUAN TRỌNG: Quy trình này BẮT BUỘC dùng WebSearch

Trước khi viết bất kỳ điều gì về thị trường, PHẢI thực hiện ít nhất 6-10 lần search thực tế.
...
Thực hiện WebSearch cho từng mảng. Ghi lại kết quả thực tế.
...
- Tất cả kết quả phải đến từ search thực tế, có URL nguồn khi có thể
...
- Nếu search không tìm được đủ dữ liệu cho một mảng, ghi rõ "Không tìm thấy đối thủ trong mảng này — đây là cơ hội"
