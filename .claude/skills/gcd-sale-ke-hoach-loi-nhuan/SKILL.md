---
name: gcd-sale-ke-hoach-loi-nhuan
description: >
...
- **TẦNG TRÊN (làm trước):** dựng mô hình kinh doanh định tính bằng [[gcd-sale-business-model-canvas]] (9 ô: bán cho ai, giá trị gì, kiếm tiền kiểu nào), rồi **định giá & thiết kế offer** bằng [[gcd-sale-dinh-gia-offer]] (giá & CP biến đổi 3 tầng đổ thẳng vào bảng Sản phẩm của skill này). Ô *Dòng doanh thu* BMC → Sản phẩm/giá; ô *Cơ cấu chi phí* → chi phí cố định/biến đổi. Đừng tính hòa vốn khi mô hình còn là giả định chưa kiểm chứng.
...
- **KHÔNG dùng** (chuyển skill khác):
  - Tính ngược **traffic/CVR/CAC** từ doanh thu → [[gcd-sale-muc-tieu-tai-chinh]] (toán phễu marketing). Skill này lo **lợi nhuận–hòa vốn–chi phí**, hai cái bổ trợ nhau.
  - Thiết kế phễu/LTV → [[gcd-sale-pheu-ltv]] · Ngân sách ads/CRM → [[gcd-sale-ngan-sach-ads-crm]].
